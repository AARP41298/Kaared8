...
package com.example.kaared_v08.DB;
...
public class TinyDBCitas {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDBCitas(Context appContext) {
    ...
    public ArrayList<Citas> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Citas> objects =  new ArrayList<Citas>();

    	for(String jObjString : objStrings){
            Citas value  = gson.fromJson(jObjString,  Citas.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Citas> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Citas obj : objArray){
