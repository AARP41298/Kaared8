...
public class TinyDBCaja {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDBCaja(Context appContext) {
    ...
    public ArrayList<Caja> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Caja> objects =  new ArrayList<Caja>();

    	for(String jObjString : objStrings){
            Caja value  = gson.fromJson(jObjString,  Caja.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Caja> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Caja obj : objArray){
